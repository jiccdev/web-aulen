        ...
        <Col sm={12} lg={12} xl={12} className={styles.investingCol}>
          <div className={styles.investingColContent}>
            ...
            <p>
              ...
              de rentabilidad por operación.
            </p>

            <p>
              Invierte de manera segura, y cuenta con la asesoría de expertos
              que te guiaran según tus objetivos, desde la elección del inmueble
              hasta la capitalización de tu inversión.
            </p>
